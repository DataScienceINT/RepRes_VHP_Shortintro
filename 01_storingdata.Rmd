...
A quite common way to organise our digital files, is by making categories. For instance, both of your teachers today, previously organised their laptops similar to:
...
So when managing files in projects adhere to the following guidelines
 ...
 1. **Create a separate folder for each (analytics) project** . Keep the unit of a project small. So "VHP4Safety" is way too big.
 1. **Use the same folder structure in every project** Better even: agree on a folder structure as group.
 1. **Do not deeply nest folders** (max 2-3 levels, so no *project/documentation/applications/metc/first_communication/input/docs/moredocs/mail.txt* or my personal favorite *project/documentation/cleanthis/tobecleaned/courses/docs*)
 ...
 1. **Do not manually edit data source files.** if you can prevent it. You can (_almost_) always solve this using code.If you absolutely have to, record your changes in the README.txt file. (another reason to learn programming! Try [R](https://r4ds.had.co.nz/) which we recommend in life sciences, [Python](https://wesmckinney.com/book/), [Julia](https://julialang.org/learning/), etc.)
...
│   │       │   ├── Patient_3.xlsx
│   │       │   └── patient_1.xlsx
│   │       └── someweirdfilenamecontchangeit.txt
│   ├── documentation
│   ├── manuscript
│   │   └── me_et al , 2020.docx
│   └── methods
...
Over at the [The Carpentries Incubator](https://carpentries-incubator.github.io/fair-bio-practice/05-intro-to-metadata/index.html#types-of-metadata), there is a really nice example of meta data in life sciences.
...
## Key points
 ...
 - don't change data files, use versioning and code
 - always keep current, used, data in the projectA/data/data_current folder, store older versions in subfolders called `projectA/data/v1`, `projectA/data/v2` etc

## **EXTRA Exercise A2:** Identifying metadata types {.blauw}
...
## **EXTRA Exercise A3:** starting to add meta data files {.blauw}
...
## EXTRA Version controlling data & data provenance

Important in a project like VHP4Safety is data provenance. Provenance describes the the place of origin or earliest known history of something.
